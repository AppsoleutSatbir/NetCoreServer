	...
	public class SslClient : IDisposable
	{
		...
		public virtual bool Connect()
		{
			...
			catch (SocketException a_ex)
			{
				...
				SendError(a_ex.SocketErrorCode, a_ex);
		...
		/// <param name="ex"></param>
		protected virtual void OnError(SocketError error, Exception ex = null) { }
		...
		/// <param name="error">Socket error code</param>
		/// <param name="ex"></param>
		private void SendError(SocketError error, Exception ex = null)
		{
