...
namespace NetCoreServer
{
	...
	public class HttpServer : TcpServer
	{
		...
		public HttpServer(IPAddress address, int port) : base(null, address, port) { Cache = new FileCache(); }
		/// <summary>
		/// Initialize HTTP server with a given IP address and port number
		/// </summary>
		/// <param name="address">IP address</param>
		/// <param name="port">Port number</param>
		public HttpServer(string address, int port) : base(null, address, port) { Cache = new FileCache(); }
		/// <summary>
		/// Initialize HTTP server with a given DNS endpoint
		/// </summary>
		/// <param name="endpoint">DNS endpoint</param>
		public HttpServer(DnsEndPoint endpoint) : base(null, endpoint) { Cache = new FileCache(); }
		/// <summary>
		/// Initialize HTTP server with a given IP endpoint
		/// </summary>
		/// <param name="endpoint">IP endpoint</param>
		public HttpServer(IPEndPoint endpoint) : base(null, endpoint) { Cache = new FileCache(); }
