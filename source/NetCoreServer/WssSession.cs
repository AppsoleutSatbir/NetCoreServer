...
namespace NetCoreServer
{
	...
	public class WssSession : HttpsSession, IWebSocket
	{
		...
		public virtual bool Close(int status, ReadOnlySpan<byte> buffer) { SendCloseAsync(status, buffer); base.Disconnect("WssSession::Close:" + status); return true; }
