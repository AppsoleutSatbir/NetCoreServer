...
namespace NetCoreServer
{
	...
	public class HttpsServer : SslServer
	{
		...
		public HttpsServer(SslContext context, IPAddress address, int port) : base(null, context, address, port) { Cache = new FileCache(); }
		/// <summary>
		/// Initialize HTTPS server with a given IP address and port number
		/// </summary>
		/// <param name="context">SSL context</param>
		/// <param name="address">IP address</param>
		/// <param name="port">Port number</param>
		public HttpsServer(SslContext context, string address, int port) : base(null, context, address, port) { Cache = new FileCache(); }
		/// <summary>
		/// Initialize HTTPS server with a given DNS endpoint
		/// </summary>
		/// <param name="context">SSL context</param>
		/// <param name="endpoint">DNS endpoint</param>
		public HttpsServer(SslContext context, DnsEndPoint endpoint) : base(null, context, endpoint) { Cache = new FileCache(); }
		/// <summary>
		/// Initialize HTTPS server with a given IP endpoint
		/// </summary>
		/// <param name="context">SSL context</param>
		/// <param name="endpoint">IP endpoint</param>
		public HttpsServer(SslContext context, IPEndPoint endpoint) : base(null, context, endpoint) { Cache = new FileCache(); }
